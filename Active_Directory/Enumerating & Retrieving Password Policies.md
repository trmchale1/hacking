...
```shell-session
trmchale@htb[/htb]$ crackmapexec smb 172.16.5.5 -u avazquez -p Password123 --pass-pol
...
```shell-session
trmchale@htb[/htb]$ enum4linux -P 172.16.5.5
...
```shell-session
trmchale@htb[/htb]$ enum4linux-ng -P 172.16.5.5 -oA ilfreight
...
```shell-session
trmchale@htb[/htb]$ cat ilfreight.json 
