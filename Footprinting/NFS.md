...
```shell-session
trmchale@htb[/htb]$ cat /etc/exports 
...
```shell-session
trmchale@htb[/htb]$ sudo nmap 10.129.14.128 -p111,2049 -sV -sC
...
```shell-session
trmchale@htb[/htb]$ sudo nmap --script nfs* 10.129.14.128 -sV -p111,2049
...
```shell-session
trmchale@htb[/htb]$ showmount -e 10.129.14.128
...
```shell-session
trmchale@htb[/htb]$ mkdir target-NFS
trmchale@htb[/htb]$ sudo mount -t nfs 10.129.14.128:/ ./target-NFS/ -o nolock
trmchale@htb[/htb]$ cd target-NFS
...
```shell-session
trmchale@htb[/htb]$ cd ..
trmchale@htb[/htb]$ sudo umount ./target-NFS
```