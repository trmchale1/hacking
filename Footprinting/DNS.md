...
```shell-session
trmchale@htb[/htb]$ dig soa www.inlanefreight.com
...
```shell-session
trmchale@htb[/htb]$ dig ns inlanefreight.htb @10.129.14.128
...
```shell-session
trmchale@htb[/htb]$ dig CH TXT version.bind 10.129.120.85
...
```shell-session
trmchale@htb[/htb]$ dig any inlanefreight.htb @10.129.14.128
...
```shell-session
trmchale@htb[/htb]$ dig axfr inlanefreight.htb @10.129.14.128
...
```shell-session
trmchale@htb[/htb]$ dig axfr internal.inlanefreight.htb @10.129.14.128
...
```shell-session
trmchale@htb[/htb]$ for sub in $(cat /opt/useful/SecLists/Discovery/DNS/subdomains-top1million-110000.txt);do dig $sub.inlanefreight.htb @10.129.14.128 | grep -v ';\|SOA' | sed -r '/^\s*$/d' | grep $sub | tee -a subdomains.txt;done
...
```shell-session
trmchale@htb[/htb]$ dnsenum --dnsserver 10.129.14.128 --enum -p 0 -s 0 -o subdomains.txt -f /opt/useful/SecLists/Discovery/DNS/subdomains-top1million-110000.txt inlanefreight.htb
