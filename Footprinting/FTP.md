...
```shell-session
trmchale@htb[/htb]$ sudo apt install vsftpd 
```
...
```shell-session
trmchale@htb[/htb]$ cat /etc/vsftpd.conf | grep -v "#"
```
...
```shell-session
trmchale@htb[/htb]$ cat /etc/ftpusers
...
```shell-session
trmchale@htb[/htb]$ ftp 10.129.14.136
...
```shell-session
trmchale@htb[/htb]$ ls | grep Notes.txt
...
```shell-session
trmchale@htb[/htb]$ wget -m --no-passive ftp://anonymous:anonymous@10.129.14.136
...
```shell-session
trmchale@htb[/htb]$ touch testupload.txt
```
...
```shell-session
trmchale@htb[/htb]$ sudo nmap --script-updatedb
...
```shell-session
trmchale@htb[/htb]$ find / -type f -name ftp* 2>/dev/null | grep scripts
...
```shell-session
trmchale@htb[/htb]$ sudo nmap -sV -p21 -sC -A 10.129.14.136
...
```shell-session
trmchale@htb[/htb]$ sudo nmap -sV -p21 -sC -A 10.129.14.136 --script-trace
...
```shell-session
trmchale@htb[/htb]$ nc -nv 10.129.14.136 21
```

  FTP

```shell-session
trmchale@htb[/htb]$ telnet 10.129.14.136 21
```
...
```shell-session
trmchale@htb[/htb]$ openssl s_client -connect 10.129.14.136:21 -starttls ftp
