...
```shell-session
trmchale@htb[/htb]$ curl -I inlanefreight.com
```
...
```shell-session
trmchale@htb[/htb]$ curl -I https://inlanefreight.com
...
```shell-session
trmchale@htb[/htb]$ curl -I https://www.inlanefreight.com
...
```shell-session
trmchale@htb[/htb]$ pip3 install git+https://github.com/EnableSecurity/wafw00f
```
...
```shell-session
trmchale@htb[/htb]$ wafw00f inlanefreight.com
...
```shell-session
trmchale@htb[/htb]$ sudo apt update && sudo apt install -y perl
trmchale@htb[/htb]$ git clone https://github.com/sullo/nikto
trmchale@htb[/htb]$ cd nikto/program
trmchale@htb[/htb]$ chmod +x ./nikto.pl
```
...
```shell-session
trmchale@htb[/htb]$ nikto -h inlanefreight.com -Tuning b
```
