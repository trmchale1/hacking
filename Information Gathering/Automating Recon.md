...
```shell-session
trmchale@htb[/htb]$ git clone https://github.com/thewhiteh4t/FinalRecon.git
trmchale@htb[/htb]$ cd FinalRecon
trmchale@htb[/htb]$ pip3 install -r requirements.txt
trmchale@htb[/htb]$ chmod +x ./finalrecon.py
trmchale@htb[/htb]$ ./finalrecon.py --help
...
```shell-session
trmchale@htb[/htb]$ ./finalrecon.py --headers --whois --url http://inlanefreight.com
